...
element_handler.__name__ = 'inbound_email_messages_type';
...
eh_cache.add('{http://evpoco.tekenlight.org}inbound_email_messages_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org}inbound_email_messages_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org'
    element_handler.properties.q_name.local_name = 'inbound_email_messages_type'
...
do
    ...
    do
        element_handler.properties.subelement_properties['{}attachments'] = 
            (basic_stuff.get_element_handler('http://evpoco.tekenlight.org', 'attachment_dtls_type_2'):
