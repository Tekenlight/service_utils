...
element_handler.__name__ = 'argument_type_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/message_rules}argument_type_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/message_rules}argument_type_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/message_rules'
    element_handler.properties.q_name.local_name = 'argument_type_type'
...
do
    ...
    element_handler.local_facets.enumeration[1] = 'scalar';
    element_handler.local_facets.enumeration[2] = 'array';
