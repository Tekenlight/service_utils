...
element_handler.__name__ = 'rule_type_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/message_rules}rule_type_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/message_rules}rule_type_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/message_rules'
    element_handler.properties.q_name.local_name = 'rule_type_type'
...
do
    ...
    element_handler.local_facets.enumeration[1] = 'independent';
    element_handler.local_facets.enumeration[2] = 'dependent';
