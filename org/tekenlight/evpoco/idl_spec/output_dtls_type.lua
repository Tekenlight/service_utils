...
element_handler.__name__ = 'output_dtls_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/idl_spec}output_dtls_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/idl_spec}output_dtls_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/idl_spec'
    element_handler.properties.q_name.local_name = 'output_dtls_type'
