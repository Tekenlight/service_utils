...
element_handler.__name__ = 'host_url_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/idl_spec}host_url_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/idl_spec}host_url_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/idl_spec'
    element_handler.properties.q_name.local_name = 'host_url_type'
