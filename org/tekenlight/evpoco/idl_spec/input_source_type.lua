...
element_handler.__name__ = 'input_source_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/idl_spec}input_source_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/idl_spec}input_source_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/idl_spec'
    element_handler.properties.q_name.local_name = 'input_source_type'
...
do
    ...
    element_handler.local_facets.enumeration[1] = 'query_param';
    element_handler.local_facets.enumeration[2] = 'request_body';
