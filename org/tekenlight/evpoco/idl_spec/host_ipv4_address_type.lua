...
element_handler.__name__ = 'host_ipv4_address_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/idl_spec}host_ipv4_address_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/idl_spec}host_ipv4_address_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/idl_spec'
    element_handler.properties.q_name.local_name = 'host_ipv4_address_type'
...
do
    ...
    element_handler.local_facets.pattern[1].str_p = [=[[\d]+\.[\d]+\.[\d]+\.[\d]+]=];
