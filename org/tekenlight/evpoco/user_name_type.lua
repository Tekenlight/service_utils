...
element_handler.__name__ = 'user_name_type';
...
eh_cache.add('{http://evpoco.tekenlight.org}user_name_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org}user_name_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org'
    element_handler.properties.q_name.local_name = 'user_name_type'
...
do
    ...
    element_handler.local_facets.max_length = 256;
