...
element_handler.__name__ = 'index_column_type';
...
eh_cache.add('{http://evpoco.tekenlight.org/tbl_spec}index_column_type', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org/tbl_spec}index_column_type';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org/tbl_spec'
    element_handler.properties.q_name.local_name = 'index_column_type'
