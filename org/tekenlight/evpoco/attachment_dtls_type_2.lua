...
element_handler.__name__ = 'attachment_dtls_type_2';
...
eh_cache.add('{http://evpoco.tekenlight.org}attachment_dtls_type_2', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://evpoco.tekenlight.org}attachment_dtls_type_2';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://evpoco.tekenlight.org'
    element_handler.properties.q_name.local_name = 'attachment_dtls_type_2'
