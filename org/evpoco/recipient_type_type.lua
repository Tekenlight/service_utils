...
element_handler.__name__ = 'recipient_type_type';
...
do
    ...
    element_handler.properties.bi_type.name = 'float';
...
do
    ...
    element_handler.base.name = 'float';
    element_handler.local_facets = {};
    element_handler.local_facets.enumeration = {};
    element_handler.local_facets.enumeration[1] = '0';
    element_handler.local_facets.enumeration[2] = '1';
...
do
    element_handler.type_handler = require('org.w3.2001.XMLSchema.float_handler'):instantiate();
