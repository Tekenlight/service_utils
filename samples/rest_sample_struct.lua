...
eh_cache.add('{}rest_sample_struct', _factory);

do
    element_handler.properties = {};
    element_handler.properties.element_type = 'C';
    element_handler.properties.content_type = 'C';
    element_handler.properties.schema_type = '{}rest_sample_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'rest_sample_struct';
    element_handler.particle_properties.generated_name = 'rest_sample_struct';
end
